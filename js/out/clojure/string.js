...
{{
var G__10582 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10582;
continue;
}
} else
...
{var pred__10586 = cljs.core._EQ_;var expr__10587 = limit;if(cljs.core.truth_(pred__10586.call(null,1,expr__10587)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10586.call(null,2,expr__10587)))
...
var G__10589 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10590 = (limit__$1 - 1);
var G__10591 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10589;
limit__$1 = G__10590;
parts = G__10591;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___10593 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___10593))
{var replacement_10594 = temp__4090__auto___10593;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_10594)));
} else
{buffer.append(ch);
}
{
