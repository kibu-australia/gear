...
{{
var G__10589 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10589;
continue;
}
} else
...
{var pred__10593 = cljs.core._EQ_;var expr__10594 = limit;if(cljs.core.truth_(pred__10593.call(null,1,expr__10594)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10593.call(null,2,expr__10594)))
...
var G__10596 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10597 = (limit__$1 - 1);
var G__10598 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10596;
limit__$1 = G__10597;
parts = G__10598;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___10600 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___10600))
{var replacement_10601 = temp__4090__auto___10600;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_10601)));
} else
{buffer.append(ch);
}
{
var G__10602 = (index + 1);
index = G__10602;
continue;
}
}
