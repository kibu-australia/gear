...
reagent.impl.component.do_render = (function do_render(C){var _STAR_current_component_STAR_10621 = reagent.impl.component._STAR_current_component_STAR_;try{reagent.impl.component._STAR_current_component_STAR_ = C;
var f = (C[reagent.impl.component.cljs_render]);var _ = ((reagent.impl.util.clj_ifn_QMARK_.call(null,f))?null:(function(){throw (new Error(("Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol("util","clj-ifn?","util/clj-ifn?",-520791343,null),new cljs.core.Symbol(null,"f","f",-1640531425,null)))))))})());var p = reagent.impl.util.js_props.call(null,C);var res = ((((C["componentFunction"]) == null))?f.call(null,C):(function (){var argv = (p[reagent.impl.util.cljs_argv]);var n = cljs.core.count.call(null,argv);var G__10622 = n;switch (G__10622) {
case 1:
return f.call(null);
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_10621;
}});
reagent.impl.component.custom_wrapper = (function custom_wrapper(key,f){var G__10625 = (((key instanceof cljs.core.Keyword))?key.fqn:null);switch (G__10625) {
case "componentWillUnmount":
return ((function (G__10625){
...
{return (function() { 
var G__10627__delegate = function (args){var C = this;return cljs.core.apply.call(null,f,C,args);
};
...
return G__10627__delegate(args);
});
...
{var G__10630 = f;(G__10630["__reactDontBind"] = true);
return G__10630;
} else
{return f;
}
...
{var wrap = reagent.impl.component.custom_wrapper.call(null,key,f);if(cljs.core.truth_((function (){var and__7914__auto__ = wrap;if(cljs.core.truth_(and__7914__auto__))
{return f;
} else
...
reagent.impl.component.wrap_funs = (function wrap_funs(fun_map){var render_fun = (function (){var or__7926__auto__ = new cljs.core.Keyword(null,"componentFunction","componentFunction",1139645287).cljs$core$IFn$_invoke$arity$1(fun_map);if(cljs.core.truth_(or__7926__auto__))
{return or__7926__auto__;
} else
{return new cljs.core.Keyword(null,"render","render",4374279432).cljs$core$IFn$_invoke$arity$1(fun_map);
}
})();var _ = ((reagent.impl.util.clj_ifn_QMARK_.call(null,render_fun))?null:(function(){throw (new Error(("Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(("Render must be a function, not "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun))))+"\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol("util","clj-ifn?","util/clj-ifn?",-520791343,null),new cljs.core.Symbol(null,"render-fun","render-fun",-447610239,null)))))))})());var name = (function (){var or__7926__auto__ = new cljs.core.Keyword(null,"displayName","displayName",2728053215).cljs$core$IFn$_invoke$arity$1(fun_map);if(cljs.core.truth_(or__7926__auto__))
{return or__7926__auto__;
} else
{var or__7926__auto____$1 = render_fun.displayName;if(cljs.core.truth_(or__7926__auto____$1))
...
reagent.impl.component.map_to_js = (function map_to_js(m){return cljs.core.reduce_kv.call(null,(function (o,k,v){var G__10632 = o;(G__10632[cljs.core.name.call(null,k)] = v);
return G__10632;
}),{},m);
});
...
{} else
{throw (new Error(("Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"map?","map?",-1637187556,null),new cljs.core.Symbol(null,"body","body",-1637502117,null)))))));
}
...
return (function() { 
var G__10633__delegate = function (args){return as_component.call(null,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
