...
reagent.impl.batching.next_tick = ((cljs.core.not.call(null,reagent.impl.util.is_client))?reagent.impl.batching.fake_raf:(function (){var w = window;var or__7926__auto__ = w.requestAnimationFrame;if(cljs.core.truth_(or__7926__auto__))
{return or__7926__auto__;
} else
{var or__7926__auto____$1 = w.webkitRequestAnimationFrame;if(cljs.core.truth_(or__7926__auto____$1))
{return or__7926__auto____$1;
} else
{var or__7926__auto____$2 = w.mozRequestAnimationFrame;if(cljs.core.truth_(or__7926__auto____$2))
{return or__7926__auto____$2;
} else
{var or__7926__auto____$3 = w.msRequestAnimationFrame;if(cljs.core.truth_(or__7926__auto____$3))
...
var n__8782__auto__ = a.length;var i = 0;while(true){
if((i < n__8782__auto__))
{var C_10579 = (a[i]);if(cljs.core.truth_(C_10579.cljsIsDirty))
{C_10579.forceUpdate();
} else
{}
{
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__8493__auto__,writer__8494__auto__,opt__8495__auto__){return cljs.core._write.call(null,writer__8494__auto__,"reagent.impl.batching/RenderQueue");
});
...
reagent.impl.batching.is_reagent_component = (function is_reagent_component(C){var and__7914__auto__ = !((C == null));if(and__7914__auto__)
{var and__7914__auto____$1 = (C["props"]);if(cljs.core.truth_(and__7914__auto____$1))
...
{} else
{throw (new Error(("Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"is-reagent-component","is-reagent-component",-461933192,null),new cljs.core.Symbol(null,"C","C",-1640531460,null)))))));
}
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_10581 = C.cljsRatom;if(!((ratom_10581 == null)))
{reagent.ratom.dispose_BANG_.call(null,ratom_10581);
} else
{}
